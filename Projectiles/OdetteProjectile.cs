...
{
    class OdetteProjectile : ModProjectile
    {
        private int effectiveTime = 40;
        private int hitboxW = 60;
        private int hitboxH = 60;
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Odette");
        }
        ...
        public override void AI()
        {
            ...
            {
                Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, DustID.Shadowflame, Main.rand.NextFloat(-5, 5), Main.rand.NextFloat(-5, 5));
            }
        }
